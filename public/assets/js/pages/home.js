...
export function renderHome(container) {
  container.innerHTML = `
    ...
    <section class="home-section">
      <div class="home-section__inner home-section__inner--center">
        ...
        <div class="home-map-btns">
          <a href="https://waze.com/ul?ll=30.6167,34.7833&navigate=yes" target="_blank" rel="noopener" class="home-map-btn">
          ...
          <a href="https://www.google.com/maps/dir/?api=1&destination=30.6167,34.7833" target="_blank" rel="noopener" class="home-map-btn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
            Google Maps
          </a>
        </div>
    ...
    <section class="home-section home-section--dark">
      <div class="home-section__inner">
        <h2 class="home-section__title" data-i18n="contacts.title">${i18n.t('contacts.title')}</h2>
        <div class="home-contacts">
          <div class="home-contact">
            <span class="home-contact__name">${i18n.t('contacts.arthur')}</span>
            <a href="https://wa.me/972548107581" target="_blank" rel="noopener" class="home-contact__btn" aria-label="WhatsApp Arthur">
          ...
          <div class="home-contact">
            <span class="home-contact__name">${i18n.t('contacts.andrey')}</span>
            <a href="https://wa.me/972547564800" target="_blank" rel="noopener" class="home-contact__btn" aria-label="WhatsApp Andrey">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.553 4.12 1.523 5.855L0 24l6.335-1.652A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.875 0-3.615-.525-5.107-1.432l-.366-.217-3.795.99.999-3.648-.238-.378A9.69 9.69 0 0 1 2.25 12 9.75 9.75 0 1 1 12 21.75z"/></svg>
            </a>
          </div>
          <div class="home-contact">
            <span class="home-contact__name">${i18n.t('contacts.vladimir')}</span>
            <a href="https://wa.me/972549731889" target="_blank" rel="noopener" class="home-contact__btn" aria-label="WhatsApp Vladimir">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.553 4.12 1.523 5.855L0 24l6.335-1.652A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.875 0-3.615-.525-5.107-1.432l-.366-.217-3.795.99.999-3.648-.238-.378A9.69 9.69 0 0 1 2.25 12 9.75 9.75 0 1 1 12 21.75z"/></svg>
            </a>
          </div>
          <div class="home-contact">
            <span class="home-contact__name">${i18n.t('contacts.robert')}</span>
            <a href="https://wa.me/972528601612" target="_blank" rel="noopener" class="home-contact__btn" aria-label="WhatsApp Robert">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.553 4.12 1.523 5.855L0 24l6.335-1.652A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.875 0-3.615-.525-5.107-1.432l-.366-.217-3.795.99.999-3.648-.238-.378A9.69 9.69 0 0 1 2.25 12 9.75 9.75 0 1 1 12 21.75z"/></svg>
            </a>
          </div>
          <div class="home-contact">
            <span class="home-contact__name">${i18n.t('contacts.evgeny')}</span>
            <a href="https://wa.me/972542273518" target="_blank" rel="noopener" class="home-contact__btn" aria-label="WhatsApp Evgeny">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.553 4.12 1.523 5.855L0 24l6.335-1.652A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.875 0-3.615-.525-5.107-1.432l-.366-.217-3.795.99.999-3.648-.238-.378A9.69 9.69 0 0 1 2.25 12 9.75 9.75 0 1 1 12 21.75z"/></svg>
            </a>
          </div>
        </div>
